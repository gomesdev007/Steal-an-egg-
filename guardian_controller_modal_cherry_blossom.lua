-- Guardian Controller - Modal UI
-- Guardian: Cherry Blossom
-- Speed slider: 400 - 500
...
if not success or not Components then
    warn("Não foi possível carregar a biblioteca Modal.")
    return
end

local Window = Components:New("Window")({
    Title = "guardian controller",
    Description = "cherry blossom",
    Size = UDim2.fromOffset(320, 360),
})

local GuardianTab = Window:AddTab("Guardian")

GuardianTab:New("Title")({
    Title = "guardian",
    Description = "guardian controller",
})
...
local function setToggleState(value)
    ...
    pcall(function()
        GuardianToggle:SetTitle(value and "guardian: on" or "guardian: off")
    end)

    pcall(function()
        GuardianToggle:SetDescription(value and "active" or "inactive")
    end)
end
...
GuardianToggle = GuardianTab:New("Toggle")({
    Title = "guardian: off",
...
GuardianTab:New("Slider")({
    Title = "speed",
    Description = "normal guardian speed",
    Default = 400,
    Minimum = 400,
    Maximum = 500,
    DecimalCount = 0,
