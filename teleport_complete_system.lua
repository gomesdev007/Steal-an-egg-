...
--
-- Main relevant components in the source:
--   l4  = complete teleport/snipe cycle
--   T4  = farm-mode controller (WARP/TWEEN/NONE)
--   N4  = target selection and scoring
--   X4  = temporary target blacklist/state
--   h.selectedZones / h.selectedRarities = egg selection configuration
--   fallback UI = activation toggle + zone/rarity selectors
--
-- Source file: Opensource new.txt
...
H( "[+] Dice Hub v42.64 Ready! All-In-One Built-in Anti-AFK & Prometheus Ready!" )